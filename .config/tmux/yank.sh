...
# FIXME need to use wl-copy and wl-paste on Linux now. This will also mean I will need to use
# waypipe for my remote editing sessions if I want to be able to pull into my local clipboard.
copy_backend=""
